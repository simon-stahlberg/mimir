...
def test_generalized_state_space_without_symmetry_reduction():
    ...
    generalized_state_space = datasets.GeneralizedStateSpace(generalized_search_context)
...
def test_generalized_state_space_with_symmetry_reduction():
    ...
    generalized_search_context = search.GeneralizedSearchContext(domain_filepath, [problem_filepath_1, problem_filepath_2])
    generalized_state_space = datasets.GeneralizedStateSpace(generalized_search_context, generalized_state_space_options)
