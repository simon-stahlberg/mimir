...
private:
    ...
    friend class GroundedAxiomEvaluatorEventHandlerBase<DefaultGroundedAxiomEvaluatorEventHandler>;
    ...
    void on_finish_build_axiom_match_tree_impl(const match_tree::MatchTree<GroundAxiomImpl>& match_tree) const;
...
public:
    explicit DefaultGroundedAxiomEvaluatorEventHandler(bool quiet = true) :
        GroundedAxiomEvaluatorEventHandlerBase<DefaultGroundedAxiomEvaluatorEventHandler>(quiet)
    {
    }
};
