...
exp = Experiment("combined-astar-blind-30-beluga-scalability-deterministic")
...
exp.add_fetcher("baseline/2025-05-06-astar30-beluga-scalability-deterministic-eval", name="list-fetch", filter=rename_algorithm_lhs)
exp.add_fetcher("tree-compression/2025-05-06-astar30-beluga-scalability-deterministic-eval", name="tree-fetch", filter=rename_algorithm_rhs)
