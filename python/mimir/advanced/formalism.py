...
_bind("mimir_problem_get_object_count", [_int], _int)
_bind("mimir_problem_get_object", [_int, _int], _int)
...
_bind("mimir_problem_new_conjunctive_condition", [_int, _ptr, _int, _ptr, _int], _int)
_bind("mimir_problem_new_ground_action", [_int, _int, _ptr, _int], _int)
_bind("mimir_problem_new_state", [_int, _ptr, _int], _int)
_bind("mimir_goal_create", [_int, _ptr, _int], _int)
...
_bind("mimir_action_get_effect_count", [_int], _int)
_bind("mimir_action_get_effect", [_int, _int], _int)
