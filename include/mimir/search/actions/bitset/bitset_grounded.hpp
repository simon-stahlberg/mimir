#ifndef MIMIR_SEARCH_ACTIONS_BITSET_BITSET_GROUNDED_HPP_
#define MIMIR_SEARCH_ACTIONS_BITSET_BITSET_GROUNDED_HPP_
...
*/
template<>
class Builder<ActionDispatcher<BitsetActionTag, GroundedTag, BitsetStateTag>>
    : public IBuilderBase<Builder<ActionDispatcher<BitsetActionTag, GroundedTag, BitsetStateTag>>>
    , public IActionBuilder<Builder<ActionDispatcher<BitsetActionTag, GroundedTag, BitsetStateTag>>>
{
private:
...
*/
template<>
class View<ActionDispatcher<BitsetActionTag, GroundedTag, BitsetStateTag>>
    : public ViewBase<View<ActionDispatcher<BitsetActionTag, GroundedTag, BitsetStateTag>>>
    , public IActionView<View<ActionDispatcher<BitsetActionTag, GroundedTag, BitsetStateTag>>>
{
private:
...
public:
    ...
    explicit View(uint8_t* data)
        : ViewBase<View<ActionDispatcher<BitsetActionTag, GroundedTag, BitsetStateTag>>>(data)
