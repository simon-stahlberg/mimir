...
exp = Experiment("combined_mimir-sparse-htg5-astar-blind")
...
exp.add_fetcher("old-mimir-sparse-htg5-astar-blind-eval", filter=rename_algorithm)
exp.add_fetcher("new-mimir-sparse-htg5-astar-blind-eval")
