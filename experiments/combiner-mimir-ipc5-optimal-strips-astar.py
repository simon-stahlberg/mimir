...
exp = Experiment("combined_mimir-sparse-ipc5-optimal-strips-astar-blind")
...
exp.add_fetcher("old-mimir-sparse-ipc5-optimal-strips-astar-blind-eval", filter=rename_algorithm)
exp.add_fetcher("new-mimir-sparse-ipc5-optimal-strips-astar-blind-eval")
