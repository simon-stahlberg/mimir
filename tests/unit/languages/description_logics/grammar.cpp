...
TEST(MimirTests, LanguagesDescriptionLogicsGrammarParseTest)
{
    ...
    {
        /* 2. Detect the non existence of a start symbol */
        auto bnf_description = std::string(R"(
    [start_symbols]
    ...
    {
        /* 3. Detect that a start symbol does not appear in a head. */
        auto bnf_description = std::string(R"(
    [start_symbols]
        concept = <concept_start>
        role = <role_undefined>
    ...
    {
        /* 4. Detect that start symbol falsely appears in a body. */
        auto bnf_description = std::string(R"(
    [start_symbols]
        concept = <concept_start>
        role = <role>
