...
public static partial class Exports
{
    ...
    private sealed class CallbackHeuristic : IHeuristic
    {
        ...
        public CallbackHeuristic(Problem problem, IntPtr evaluate, IntPtr isPreferred)
        {
            _problem = problem;
            _evaluate = evaluate;
        ...
        IntPtr isPreferred)
    {
        ...
        return ObjectRegistry.Store(new CallbackHeuristic(problem, evaluate, isPreferred));
    }
}
