...
#ifndef MIMIR_LANGUAGES_GENERAL_POLICIES_CONDITION_INTERFACE_HPP_
#define MIMIR_LANGUAGES_GENERAL_POLICIES_CONDITION_INTERFACE_HPP_
...
public:
    ...
    virtual bool evaluate_with_debug(dl::EvaluationContext& source_context) const = 0;
