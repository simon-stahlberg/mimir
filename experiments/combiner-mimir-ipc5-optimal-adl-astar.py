...
exp = Experiment("combined_mimir-sparse-ipc5-optimal-adl-astar-blind")
...
exp.add_fetcher("old-mimir-sparse-ipc5-optimal-adl-astar-blind-eval", filter=rename_algorithm)
exp.add_fetcher("new-mimir-sparse-ipc5-optimal-adl-astar-blind-eval")
