...
*/
template<>
class View<StateTag<Grounded>> : public ViewBase<View<StateTag<Grounded>>>, public StateViewBase<View<StateTag<Grounded>>> {
private:
    ...
    friend class ViewBase<View<StateTag<Grounded>>>;
    ...
    friend class StateViewBase<View<StateTag<Grounded>>>;

public:
    /// @brief Create a view on a SearchNodeTag.
    explicit View(char* data) : ViewBase<View<StateTag<Grounded>>>(data) { }
};
...
namespace std {
    template<>
    struct hash<mimir::View<mimir::StateTag<mimir::Grounded>>>
    {
        std::size_t operator()(const mimir::View<mimir::StateTag<mimir::Grounded>>& view) const {
            return view.hash();
        }
    };
}  // namespace std
