...
namespace mimir 
{
    ...
    void ConditionLiteralImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& /*options*/) const {
        out << *m_literal;
    }
    ...
    void ConditionAndImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& options) const {
        out << "(and ";
    ...
    void ConditionOrImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& options) const {
        out << "(or ";
        for (size_t i = 0; i < m_conditions.size(); ++i) {
            if (i != 0) out << " ";
            std::visit(loki::pddl::StringifyVisitor(out, options), *m_conditions[i]);
    ...
    void ConditionNotImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& options) const {
        out << "(not ";
    ...
    void ConditionImplyImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& options) const {
        out << "(imply ";
    ...
    void ConditionExistsImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& options) const {
        out << "(exists (";
    ...
    void ConditionForallImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& options) const {
        out << "(forall (";
        for (size_t i = 0; i < m_parameters.size(); ++i) {
            if (i != 0) out << " ";
            out << *m_parameters[i];
...
namespace std 
{
    bool less<mimir::Condition>::operator()(
        const mimir::Condition& left_condition,
        const mimir::Condition& right_condition) const {
        return std::visit(loki::pddl::LessComparatorVisitor(), *left_condition, *right_condition);
    }

    std::size_t hash<mimir::ConditionLiteralImpl>::operator()(const mimir::ConditionLiteralImpl& condition) const {
        return condition.hash();
    }

    std::size_t hash<mimir::ConditionAndImpl>::operator()(const mimir::ConditionAndImpl& condition) const {
        return condition.hash();
    }

    std::size_t hash<mimir::ConditionOrImpl>::operator()(const mimir::ConditionOrImpl& condition) const {
        return condition.hash();
    }

    std::size_t hash<mimir::ConditionNotImpl>::operator()(const mimir::ConditionNotImpl& condition) const {
        return condition.hash();
    }

    std::size_t hash<mimir::ConditionImplyImpl>::operator()(const mimir::ConditionImplyImpl& condition) const {
        return condition.hash();
    }

    std::size_t hash<mimir::ConditionExistsImpl>::operator()(const mimir::ConditionExistsImpl& condition) const {
        return condition.hash();
    }

    std::size_t hash<mimir::ConditionForallImpl>::operator()(const mimir::ConditionForallImpl& condition) const {
        return condition.hash();
    }
}
