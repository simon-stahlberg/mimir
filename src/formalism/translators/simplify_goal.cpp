...
static loki::Condition simplify_goal_condition(loki::Condition goal_condition,
...
void SimplifyGoalTranslator::prepare_impl(loki::Predicate predicate) { m_simple_and_derived_predicate_names.insert(predicate->get_name()); }

loki::Problem SimplifyGoalTranslator::translate_impl(loki::Problem problem)
{
