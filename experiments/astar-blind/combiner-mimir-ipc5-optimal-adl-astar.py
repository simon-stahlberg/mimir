...
exp = Experiment("combined_mimir-ipc5-optimal-adl-astar-blind")
...
exp.add_fetcher("old-mimir-ipc5-optimal-adl-astar-blind-eval", filter=rename_algorithm)
exp.add_fetcher("new-mimir-ipc5-optimal-adl-astar-blind-eval")
