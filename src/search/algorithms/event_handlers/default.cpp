...
void DefaultAlgorithmEventHandler::on_finish_f_layer_impl(uint64_t f_value, uint64_t num_expanded_states) const
{
    std::cout << "[Algorithm] Finished state expansion until f-layer " << f_value << " with num states " << num_expanded_states << std::endl;
}
