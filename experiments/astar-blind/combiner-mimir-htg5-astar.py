...
exp = Experiment("combined_mimir-htg5-astar-blind")
...
exp.add_fetcher("old-mimir-htg5-astar-blind-eval", filter=rename_algorithm)
exp.add_fetcher("new-mimir-htg5-astar-blind-eval")
