...
*/
template<>
class Builder<DefaultStateTag<LiftedTag>> : public BuilderBase<Builder<DefaultStateTag<LiftedTag>>>, public StateBuilderBase<Builder<DefaultStateTag<LiftedTag>>> {
    state_id_type m_id;
    ...
    friend class BuilderBase<Builder<DefaultStateTag<LiftedTag>>>;

    /* Implement StateBuilderBase interface */
    void set_id_impl(state_id_type id) { m_id = id; }

    friend class StateBuilderBase<Builder<DefaultStateTag<LiftedTag>>>;
};
...
*/
template<>
class View<DefaultStateTag<LiftedTag>> : public ViewBase<View<DefaultStateTag<LiftedTag>>>, public StateViewBase<View<DefaultStateTag<LiftedTag>>> {
private:
    ...
    friend class ViewBase<View<DefaultStateTag<LiftedTag>>>;
    ...
    friend class StateViewBase<View<DefaultStateTag<LiftedTag>>>;

public:
    explicit View(char* data) : ViewBase<View<DefaultStateTag<LiftedTag>>>(data) { }
};
