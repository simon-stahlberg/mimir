...
void bind_datasets(nb::module_& m)
{
    ...
    m.def("get_state", [](const graphs::ProblemVertex& self) -> search::State { return graphs::get_state(self); }, "vertex"_a);
    m.def("get_problem", [](const graphs::ProblemVertex& self) -> const Problem& { return graphs::get_problem(self); }, "vertex"_a);
    ...
    m.def("get_action", [](const graphs::ProblemEdge& self) -> GroundAction { return graphs::get_action(self); }, "edge"_a);
    m.def("get_problem", [](const graphs::ProblemEdge& self) -> const Problem& { return graphs::get_problem(self); }, "edge"_a);
