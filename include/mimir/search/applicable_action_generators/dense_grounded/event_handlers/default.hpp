...
#ifndef MIMIR_SEARCH_APPLICABLE_ACTION_GENERATORS_DENSE_GROUNDED_EVENT_HANDLERS_DEFAULT_HPP_
#define MIMIR_SEARCH_APPLICABLE_ACTION_GENERATORS_DENSE_GROUNDED_EVENT_HANDLERS_DEFAULT_HPP_
...
private:
    ...
    void on_finish_delete_free_exploration_impl(const GroundAtomList<FluentPredicateImpl>& reached_atoms,
