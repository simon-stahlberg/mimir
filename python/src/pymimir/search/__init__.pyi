...
from pymimir.formalism import Problem, PDDLFactories, GroundAtom
...
class ISSG:
    ...
    def get_or_create_state(self, atoms : List[GroundAtom]) -> State: ...
    def get_or_create_successor_state(self, state: State, action: GroundAction) -> State: ...
    def get_non_extended_state(self, state: State) -> State: ...
