...
from suite import SUITE_IPC_LEARNING
from suite_test import SUITE_IPC_LEARNING_TEST
...
BENCHMARKS_DIR = Path(os.environ["BENCHMARKS_PDDL"]) / "ipc2023-learning"
...
if REMOTE:
    ...
    SUITE = SUITE_IPC_LEARNING
    TIME_LIMIT = 30 * 60 
else:
    ENV = LocalEnvironment(processes=12)
    SUITE = SUITE_IPC_LEARNING_TEST
    TIME_LIMIT = 3
ATTRIBUTES = [
    "run_dir",
    "coverage",
