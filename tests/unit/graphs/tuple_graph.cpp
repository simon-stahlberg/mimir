...
TEST(MimirTests, GraphsTupleGraphAdmissibleChainTest)
{
    ...
    auto tuple_graph_0 = tuple_graph_factory_0.create(state_space->get_state_repository()->get_or_create_initial_state(state_repository_workspace));
    auto tuple_graph_1 = tuple_graph_factory_1.create(state_space->get_state_repository()->get_or_create_initial_state(state_repository_workspace));
    auto tuple_graph_2 = tuple_graph_factory_2.create(state_space->get_state_repository()->get_or_create_initial_state(state_repository_workspace));
    auto tuple_graph_3 = tuple_graph_factory_3.create(state_space->get_state_repository()->get_or_create_initial_state(state_repository_workspace));
