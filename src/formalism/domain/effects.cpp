...
namespace mimir 
{
    ...
    void EffectLiteralImpl::str_impl(std::ostringstream& out, const loki::FormattingOptions& /*options*/) const {
        out << *m_literal;
    }
    ...
    /* EffectNumeric */
    EffectNumericImpl::EffectNumericImpl(int identifier, loki::pddl::AssignOperatorEnum assign_operator, Function function, FunctionExpression function_expression)
        : Base(identifier)
    ...
    loki::pddl::AssignOperatorEnum EffectNumericImpl::get_assign_operator() const {
...
namespace std 
{
    bool less<mimir::Effect>::operator()(
        const mimir::Effect& left_effect,
        const mimir::Effect& right_effect) const {
        return *left_effect < *right_effect;
    }

    std::size_t hash<mimir::EffectLiteralImpl>::operator()(const mimir::EffectLiteralImpl& effect) const {
        return effect.hash();
    }

    std::size_t hash<mimir::EffectAndImpl>::operator()(const mimir::EffectAndImpl& effect) const {
        return effect.hash();
    }

    std::size_t hash<mimir::EffectNumericImpl>::operator()(const mimir::EffectNumericImpl& effect) const {
        return effect.hash();
    }

    std::size_t hash<mimir::EffectConditionalForallImpl>::operator()(const mimir::EffectConditionalForallImpl& effect) const {
        return effect.hash();
    }

    std::size_t hash<mimir::EffectConditionalWhenImpl>::operator()(const mimir::EffectConditionalWhenImpl& effect) const {
        return effect.hash();
    }
}
