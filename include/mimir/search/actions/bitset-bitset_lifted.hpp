...
*/
template<>
class View<ActionDispatcher<BitsetActionTag, LiftedTag, BitsetStateTag>>
    : public ViewBase<View<ActionDispatcher<BitsetActionTag, LiftedTag, BitsetStateTag>>>
    , public IActionView<View<ActionDispatcher<BitsetActionTag, LiftedTag, BitsetStateTag>>>
{
private:
...
public:
    ...
    explicit View(uint8_t* data)
        : ViewBase<View<ActionDispatcher<BitsetActionTag, LiftedTag, BitsetStateTag>>>(data)
