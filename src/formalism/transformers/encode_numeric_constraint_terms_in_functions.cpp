...
Function<F> EncodeNumericConstraintTermsInFunctions::transform_impl(Function<F> function)
{
    ...
    auto transformed_terms = this->transform(function->get_terms());
    ...
    return m_pddl_repositories.get_or_create_function(transformed_function_skeleton, transformed_terms, parent_terms_to_terms_mapping);
}

template Function<Static> EncodeNumericConstraintTermsInFunctions::transform_impl(Function<Static> function);
template Function<Fluent> EncodeNumericConstraintTermsInFunctions::transform_impl(Function<Fluent> function);
template Function<Auxiliary> EncodeNumericConstraintTermsInFunctions::transform_impl(Function<Auxiliary> function);

NumericConstraint EncodeNumericConstraintTermsInFunctions::transform_impl(NumericConstraint numeric_constraint)
{
    ...
    return m_pddl_repositories.get_or_create_numeric_constraint(numeric_constraint->get_binary_comparator(),
                                                                this->transform(numeric_constraint->get_left_function_expression()),
                                                                this->transform(numeric_constraint->get_right_function_expression()),
                                                                terms);
}

Problem EncodeNumericConstraintTermsInFunctions::run_impl(Problem problem) { return this->transform(problem); }

EncodeNumericConstraintTermsInFunctions::EncodeNumericConstraintTermsInFunctions(PDDLRepositories& pddl_repositories) :
    BaseRecurseTransformer<EncodeNumericConstraintTermsInFunctions>(pddl_repositories)
{
}
}
