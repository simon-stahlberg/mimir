...
AAG<LiftedAAGDispatcher<DenseStateTag>>::AAG(Problem problem, PDDLFactories& ref_pddl_factories, std::shared_ptr<ILiftedAAGEventHandler> event_handler) :
    m_problem(problem),
    m_ref_pddl_factories(ref_pddl_factories),
...
[[nodiscard]] PDDLFactories& AAG<LiftedAAGDispatcher<DenseStateTag>>::get_pddl_factories_impl() { return m_ref_pddl_factories; }

[[nodiscard]] const PDDLFactories& AAG<LiftedAAGDispatcher<DenseStateTag>>::get_pddl_factories_impl() const { return m_ref_pddl_factories; }
