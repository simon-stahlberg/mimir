...
AssignmentSet<Fluent>& LiftedAxiomEvaluatorWorkspace::get_or_create_fluent_assignment_set(Problem problem, GroundAtomList<Fluent>& fluent_atoms)
{
...
AssignmentSet<Derived>& LiftedAxiomEvaluatorWorkspace::get_or_create_derived_assignment_set(Problem problem, GroundAtomList<Derived>& derived_atoms)
{
