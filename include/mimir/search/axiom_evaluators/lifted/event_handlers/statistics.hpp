...
class LiftedAxiomEvaluatorStatistics
{
private:
...
public:
    LiftedAxiomEvaluatorStatistics() :
...
inline std::ostream& operator<<(std::ostream& os, const LiftedAxiomEvaluatorStatistics& statistics)
{
