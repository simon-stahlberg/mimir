...
{
void DefaultGroundedApplicableActionGeneratorEventHandler::on_start_ground_action_instantiation_impl() const
{
    std::cout << "[GroundedApplicableActionGenerator] Started instantiating ground actions." << std::endl;
}

void DefaultGroundedApplicableActionGeneratorEventHandler::on_finish_ground_action_instantiation_impl(std::chrono::milliseconds total_time) const
{
    std::cout << "[GroundedApplicableActionGenerator] Total time for ground action instantiation: " << total_time << std::endl;
}

void DefaultGroundedApplicableActionGeneratorEventHandler::on_start_build_action_match_tree_impl() const
{
    std::cout << "[GroundedApplicableActionGenerator] Started building action match tree." << std::endl;
}

void DefaultGroundedApplicableActionGeneratorEventHandler::on_finish_build_action_match_tree_impl(const match_tree::MatchTree<GroundActionImpl>& match_tree)
{
