...
exp = Experiment("combined-astar-blind-30-minepddl")
...
exp.add_fetcher("baseline/2025-05-06-astar30-minepddl-eval", name="list-fetch", filter=rename_algorithm_lhs)
exp.add_fetcher("tree-compression/2025-05-06-astar30-minepddl-eval", name="tree-fetch", filter=rename_algorithm_rhs)
