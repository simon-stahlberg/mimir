...
namespace mimir::planners
{
    ...
    class LiftedSchemaSuccessorGenerator
    {
      private:
        ...
        /**
         * Builds a datastructure to efficiently test if an assignment is compatible with an atom in the given set.
         *
         * A set for each predicate that contains possible compatible assignments.
         * 
         * TODO: reuse memory
         */
