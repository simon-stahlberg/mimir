...
{
    {
        ...
        auto two_triangle_certificate = kfwl::compute_certificate<3>(two_triangle);
        ...
        auto sixgon_certificate = kfwl::compute_certificate<3>(sixgon);
...

    {
        ...
        auto line_graph_1_certificate = kfwl::compute_certificate<2>(line_graph_1);
        ...
        auto line_graph_2_certificate = kfwl::compute_certificate<2>(line_graph_2);
