...
*/
template<IsPlanningModeTag P, IsStateTag S>
using DefaultActionBuilder = View<DefaultActionTag<P, S>>;

template<IsPlanningModeTag P, IsStateTag S>
using DefaultActionView = View<DefaultActionTag<P, S>>;
...
*/
template<IsPlanningModeTag P, IsStateTag S>
class Builder<DefaultActionTag<P, S>>
    : public BuilderBase<Builder<DefaultActionTag<P, S>>>
    , public DefaultActionBuilderBase<Builder<DefaultActionTag<P, S>>> {
private:
...
*/
template<IsPlanningModeTag P, IsStateTag S>
class View<DefaultActionTag<P, S>>
    : public ViewBase<View<DefaultActionTag<P, S>>>
    , public DefaultActionViewBase<View<DefaultActionTag<P, S>>> {
private:
...
public:
    ...
    explicit View(char* data) : ViewBase<View<DefaultActionTag<P, S>>>(data) { }
};
