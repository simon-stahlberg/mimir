...
for task in suites.build_suite(BENCHMARKS_DIR, SUITE):
    ...
    run.set_property("algorithm", f"mimir-lifted-{lifted_kind}-numeric-astar-eager-blind")
    ...
    # multiple algorithms.
    run.set_property("id", [f"mimir-lifted-{lifted_kind}-numeric-astar-eager-blind", task.domain, task.problem])
