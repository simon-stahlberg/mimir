...
*/
template<>
class View<State<LiftedTag>> : public ViewBase<View<State<LiftedTag>>>, public StateViewBase<View<State<LiftedTag>>> {
private:
    ...
    friend class ViewBase<View<State<LiftedTag>>>;
    ...
    friend class StateViewBase<View<State<LiftedTag>>>;

public:
    /// @brief Create a view on a SearchNode.
    explicit View(char* data) : ViewBase<View<State<LiftedTag>>>(data) { }
};
