...
valla::TreeHashIDMap<>& ProblemImpl::get_inner_tree_table() { return m_inner_tree_table; }
const valla::TreeHashIDMap<>& ProblemImpl::get_inner_tree_table() const { return m_inner_tree_table; }
