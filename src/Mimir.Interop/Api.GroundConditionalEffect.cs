...
public static partial class Exports
{
    ...
    public static int GroundConditionalEffectGetEffect(int handle)
        => CreateHandle(() => RequireHandle<GroundConditionalEffect>(handle).Effect);
    ...
    public static int GceGetPositiveFluentCount(int handle)
        => ReadValue(handle, -1, (GroundConditionalEffectBase effect) => PopCount(effect.PositiveFluentConditions));
    ...
    {
        var ce = ObjectRegistry.Get<GroundConditionalEffectBase>(handle);
        if (ce == null) return 0;
    ...
    public static int GceGetNegativeFluentCount(int handle)
        => ReadValue(handle, -1, (GroundConditionalEffectBase effect) => PopCount(effect.NegativeFluentConditions));
    ...
    public static int GceGetPositiveStaticCount(int handle)
        => ReadValue(handle, -1, (GroundConditionalEffectBase effect) => PopCount(effect.PositiveStaticConditions));
    ...
    public static int GceGetNegativeStaticCount(int handle)
        => ReadValue(handle, -1, (GroundConditionalEffectBase effect) => PopCount(effect.NegativeStaticConditions));
    ...
    public static int GceGetDerivedCount(int handle)
        => ReadValue(handle, -1, (GroundConditionalEffectBase effect) => effect.DerivedConditions.Count);
    ...
    {
        var effect = ObjectRegistry.Get<GroundConditionalEffectBase>(handle);
