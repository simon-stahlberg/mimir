...
#ifndef MIMIR_LANGUAGES_DESCRIPTION_LOGICS_GRAMMAR_CONSTRUCTOR_VISITOR_TRANSLATE_ALTERNATIVES_HPP_
#define MIMIR_LANGUAGES_DESCRIPTION_LOGICS_GRAMMAR_CONSTRUCTOR_VISITOR_TRANSLATE_ALTERNATIVES_HPP_
...
class TranslateAlternativeVisitor : public Visitor
{
public:
    /* Concepts */
