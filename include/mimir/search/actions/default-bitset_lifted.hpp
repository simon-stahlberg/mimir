...
class Builder<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>
    ...
    , public IActionBuilder<Builder<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>>
{
private:
...
class View<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>
    ...
    , public IActionView<View<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>>
{
private:
