...
exp = Experiment("filtered-astar-blind-300-numeric")
...
exp.add_fetcher("data-list/2025-09-17-astar300-ipc-numeric-eval", name="list-fetch-ipc-numeric", filter=filter_list)
exp.add_fetcher("data-dtdb-s/2025-09-17-astar300-ipc-numeric-eval", name="dtdb-s-fetch-ipc-numeric", filter=filter_swiss)
exp.add_fetcher("data-dtdb-h/2025-09-17-astar300-ipc-numeric-eval", name="dtdb-h-fetch-ipc-numeric", filter=filter_hashid)

exp.add_fetcher("data-list/2025-09-17-astar300-minepddl-numeric-eval", name="list-fetch-minepddl-numeric", filter=filter_list)
exp.add_fetcher("data-dtdb-s/2025-09-17-astar300-minepddl-numeric-eval", name="dtdb-s-fetch-minepddl-numeric", filter=filter_swiss)
exp.add_fetcher("data-dtdb-h/2025-09-17-astar300-minepddl-numeric-eval", name="dtdb-h-fetch-minepddl-numeric", filter=filter_hashid)
