...
{
void DefaultEventHandlerImpl::on_start_ground_axiom_instantiation_impl() const
{
    std::cout << "[GroundedAxiomEvaluator] Started instantiating ground axioms." << std::endl;
}

void DefaultEventHandlerImpl::on_finish_ground_axiom_instantiation_impl(std::chrono::milliseconds total_time) const
{
    std::cout << "[GroundedAxiomEvaluator] Total time for ground axiom instantiation: " << total_time.count() << " ms" << std::endl;
}

void DefaultEventHandlerImpl::on_start_build_axiom_match_trees_impl() const
{
    std::cout << "[GroundedAxiomEvaluator] Started building axiom match trees." << std::endl;
}

void DefaultEventHandlerImpl::on_start_build_axiom_match_tree_impl(size_t partition_index) const
{
    std::cout << "[GroundedAxiomEvaluator] Axiom partition: " << partition_index << std::endl;
}

void DefaultEventHandlerImpl::on_finish_build_axiom_match_tree_impl(const match_tree::MatchTree<GroundAxiomImpl>& match_tree) const
{
    std::cout << match_tree.get_statistics() << std::endl;
}

void DefaultEventHandlerImpl::on_finish_build_axiom_match_trees_impl(std::chrono::milliseconds total_time) const
{
...
void DefaultEventHandlerImpl::on_end_search_impl() const {}
