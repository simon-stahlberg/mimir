...
#ifndef MIMIR_FORMALISM_DOMAIN_FUNCTION_HPP_
#define MIMIR_FORMALISM_DOMAIN_FUNCTION_HPP_
...
private:
    ...
    FunctionImpl(int identifier, loki::pddl::Function external, FunctionSkeleton function_skeleton, TermList terms);
