...
struct Context
{
    using ConceptOrRoleToDerivationRuleByName =
    ...
    ConceptOrRoleToDerivationRuleByName m_derivation_rules_by_name;

    using ConceptOrRoleToNonTerminalByName =
    ...
    ConceptOrRoleToNonTerminalByName m_non_terminals_by_name;
};
