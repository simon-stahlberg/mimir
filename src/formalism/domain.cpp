...
DomainImpl::DomainImpl(Index index,
    ...
    m_auxiliary_function(std::move(auxiliary_function)),
...
const std::optional<FunctionSkeleton<Auxiliary>>& DomainImpl::get_auxiliary_function() const { return m_auxiliary_function; }
