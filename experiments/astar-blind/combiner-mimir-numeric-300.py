...
exp = Experiment("combined-astar-blind-300-numeric")
...
exp.add_fetcher("data-list/2025-09-17-astar300-ipc-numeric-eval", name="list-fetch-ipc-numeric", filter=rename_algorithm_list)
exp.add_fetcher("data-dtdb-s/2025-09-17-astar300-ipc-numeric-eval", name="dtdb-s-fetch-ipc-numeric", filter=rename_algorithm_tree_swiss)
exp.add_fetcher("data-dtdb-h/2025-09-17-astar300-ipc-numeric-eval", name="dtdb-h-fetch-ipc-numeric", filter=rename_algorithm_tree_hashid)

exp.add_fetcher("data-list/2025-09-17-astar300-minepddl-numeric-eval", name="list-fetch-minepddl-numeric", filter=rename_algorithm_list)
exp.add_fetcher("data-dtdb-s/2025-09-17-astar300-minepddl-numeric-eval", name="dtdb-s-fetch-minepddl-numeric", filter=rename_algorithm_tree_swiss)
exp.add_fetcher("data-dtdb-h/2025-09-17-astar300-minepddl-numeric-eval", name="dtdb-h-fetch-minepddl-numeric", filter=rename_algorithm_tree_hashid)
