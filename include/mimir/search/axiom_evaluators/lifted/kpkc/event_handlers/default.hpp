...
#ifndef MIMIR_SEARCH_AXIOM_EVALUATORS_LIFTED_KPKC_EVENT_HANDLERS_DEFAULT_HPP_
#define MIMIR_SEARCH_AXIOM_EVALUATORS_LIFTED_KPKC_EVENT_HANDLERS_DEFAULT_HPP_

#include "mimir/search/axiom_evaluators/lifted/kpkc/event_handlers/base.hpp"
