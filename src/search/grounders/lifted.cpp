...
GroundedAxiomEvaluator LiftedGrounder::create_grounded_axiom_evaluator(const match_tree::Options& options,
...
LiftedGrounder::create_grounded_applicable_action_generator(const match_tree::Options& options,
