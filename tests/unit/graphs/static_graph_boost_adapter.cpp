...
TEST(MimirTests, GraphsVertexListGraphTest)
{
    ...
    const auto problem_class_state_space =
        GeneralizedStateSpace(SearchContext(ProblemImpl::create(domain_file, problem_file), SearchContext::Options(SearchContext::SearchMode::GROUNDED)));
