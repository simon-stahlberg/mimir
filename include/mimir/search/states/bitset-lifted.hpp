...
*/
template<>
class Builder<WrappedStateTag<BitsetStateTag, LiftedTag>>
    : public BuilderBase<Builder<WrappedStateTag<BitsetStateTag, LiftedTag>>>
    , public StateBuilderBase<Builder<WrappedStateTag<BitsetStateTag, LiftedTag>>> {
    state_id_type m_id;
...
*/
template<>
class View<WrappedStateTag<BitsetStateTag, LiftedTag>>
    : public ViewBase<View<WrappedStateTag<BitsetStateTag, LiftedTag>>>
    , public StateViewBase<View<WrappedStateTag<BitsetStateTag, LiftedTag>>> {
private:
...
public:
    explicit View(char* data) : ViewBase<View<WrappedStateTag<BitsetStateTag, LiftedTag>>>(data) { }
};
