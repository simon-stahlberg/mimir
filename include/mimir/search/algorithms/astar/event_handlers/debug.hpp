...
private:
    ...
    void on_generate_state_impl(State state, ConstSearchNode<double, double> search_node, Problem problem, const PDDLFactories& pddl_factories) const;

    void on_generate_state_relaxed_impl(State state, ConstSearchNode<double, double> search_node, Problem problem, const PDDLFactories& pddl_factories) const;

    void
    on_generate_state_not_relaxed_impl(State state, ConstSearchNode<double, double> search_node, Problem problem, const PDDLFactories& pddl_factories) const;
...
public:
    explicit DebugAStarAlgorithmEventHandler(bool quiet = true) : AStarAlgorithmEventHandlerBase<DebugAStarAlgorithmEventHandler>(quiet) {}
};
