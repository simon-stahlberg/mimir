...
int ProblemGoalStrategyImplCounter::count_unsatisfied_goals(State state) const
{
    ...
    num_unsatisfied_goals += count_set_difference(m_problem->get_positive_goal_atoms_indices<FluentTag>(), state->get_atoms<FluentTag>());
    num_unsatisfied_goals += count_set_difference(m_problem->get_positive_goal_atoms_indices<DerivedTag>(), state->get_atoms<DerivedTag>());
    num_unsatisfied_goals += count_set_intersection(m_problem->get_negative_goal_atoms_indices<FluentTag>(), state->get_atoms<FluentTag>());
    num_unsatisfied_goals += count_set_intersection(m_problem->get_negative_goal_atoms_indices<DerivedTag>(), state->get_atoms<DerivedTag>());
