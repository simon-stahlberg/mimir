...
#ifndef MIMIR_FORMALISM_TRANSLATORS_INITIALIZE_EQUALITY_HPP_
#define MIMIR_FORMALISM_TRANSLATORS_INITIALIZE_EQUALITY_HPP_
 ...
 */
class InitializeEqualityTranslator : public BaseCachedRecurseTranslator<InitializeEqualityTranslator>
{
private:
    /* Implement BaseCachedRecurseTranslator interface. */
    friend class BaseCachedRecurseTranslator<InitializeEqualityTranslator>;
...
public:
    explicit InitializeEqualityTranslator(loki::PDDLRepositories& pddl_repositories);
};
}
