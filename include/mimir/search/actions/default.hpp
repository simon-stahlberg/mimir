...
using DefaultActionBuilder = Builder<WrappedActionTag<DefaultActionTag, P, S>>;

template<IsPlanningModeTag P, IsStateTag S>
using DefaultActionView = View<WrappedActionTag<DefaultActionTag, P, S>>;
...
*/
template<IsPlanningModeTag P, IsStateTag S>
class Builder<WrappedActionTag<DefaultActionTag, P, S>>
    : public BuilderBase<Builder<WrappedActionTag<DefaultActionTag, P, S>>>
    , public DefaultActionBuilderBase<Builder<WrappedActionTag<DefaultActionTag, P, S>>> {
private:
...
*/
template<IsPlanningModeTag P, IsStateTag S>
class View<WrappedActionTag<DefaultActionTag, P, S>>
    : public ViewBase<View<WrappedActionTag<DefaultActionTag, P, S>>>
    , public DefaultActionViewBase<View<WrappedActionTag<DefaultActionTag, P, S>>> {
private:
...
public:
    ...
    explicit View(char* data) : ViewBase<View<WrappedActionTag<DefaultActionTag, P, S>>>(data) { }
};
