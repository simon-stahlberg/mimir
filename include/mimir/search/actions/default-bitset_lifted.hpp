#ifndef MIMIR_SEARCH_ACTIONS_DEFAULT_BITSET_LIFTED_HPP_
#define MIMIR_SEARCH_ACTIONS_DEFAULT_BITSET_LIFTED_HPP_
...
*/
template<>
class Builder<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>
    : public BuilderBase<Builder<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>>
    , public ActionBuilderBase<Builder<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>>
{
private:
...
*/
template<>
class View<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>
    : public ViewBase<View<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>>
    , public ActionViewBase<View<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>>
{
private:
...
public:
    ...
    explicit View(uint8_t* data)
        : ViewBase<View<ActionDispatcher<DefaultActionTag, LiftedTag, BitsetStateTag>>>(data)
