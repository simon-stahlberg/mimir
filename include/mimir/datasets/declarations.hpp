...
using CertificateMap = KeyValueMap<loki::ObserverPtr<const graphs::nauty::CertificateImpl>, Value>;

/// @brief Cache computed state certificates.
using StateToCertificate = search::StateMap<graphs::nauty::Certificate>;
