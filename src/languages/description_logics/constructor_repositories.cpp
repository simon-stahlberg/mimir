...
ConstructorTypeToRepository create_default_constructor_type_to_repository()
{
    return boost::hana::make_map(boost::hana::make_pair(boost::hana::type_c<ConceptBotImpl>, ConceptBotRepository {}),
